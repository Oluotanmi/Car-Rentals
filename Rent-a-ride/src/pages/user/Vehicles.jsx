...
import Filter from "../../components/utls/Filter";
...
import Sort from "../../components/utls/Sort";
import { setVariants,setVehicleDetail,showVehicles } from "../../redux/user/listAllVehicleSlice";
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            console.log(res)
            if(!res.ok){
                console.log("not success from list of vehicles");
                // setIsLoading(false)
            }
            if(res.ok){
                const data = await res.json();
